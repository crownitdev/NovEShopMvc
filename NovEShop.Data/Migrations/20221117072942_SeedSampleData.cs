    ...
    public partial class SeedSampleData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                {
                    { "HomeTitle", "NovEShop" },
                    { "HomeKeyword", "Keyword of NovEShop" },
                    { "HomeDescription", "Ecommerce Store Website" }
                });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "CreatedById", "IsActive", "IsShowOnHome", "ModifiedAt", "ModifiedById", "ParentId", "SortOrder" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, true, true, null, null, null, 1 },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, true, true, null, null, null, 2 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CreatedAt", "CreatedById", "ModifiedAt", "ModifiedById", "OriginalPrice", "Price" },
                values: new object[] { 1, new DateTime(2022, 11, 17, 14, 29, 41, 464, DateTimeKind.Local).AddTicks(8004), null, null, null, 100000m, 200000m });
